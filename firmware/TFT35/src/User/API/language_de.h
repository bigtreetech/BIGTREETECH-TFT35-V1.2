...
#define _LANGUAGE_DE_H_
    ...
    #define DE_1_DEGREE             "1°C"
    #define DE_5_DEGREE             "5°C"
    #define DE_10_DEGREE            "10°C"
    #define DE_X_INC                "X+"
    #define DE_Y_INC                "Y+"
    #define DE_Z_INC                "Z+"
    #define DE_X_DEC                "X-"
    ...
    #define DE_BUSY                 "Busy processing ,please wait..."
    #define DE_UNCONNECTED          "Keine Verbindung zum Drucker!"
    #define DE_DISCONNECT_INFO      "Der Drucker laesst sich nun ueber den Computer steuern!"
